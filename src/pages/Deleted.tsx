...
export default function DeletedPage() {
  console.log('DeletedPage component rendering');
  ...
  useEffect(() => {
    console.log('Deleted page useEffect - user:', user);
    if (!user) {
      console.log('No user found, redirecting to auth');
      navigate('/auth');
      return;
    }
    console.log('User found, fetching deleted notebooks');
    fetchDeletedNotebooks();
  }, [user, navigate]);
  ...
  console.log('Deleted page rendering main content');
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="border-b border-border bg-card/50 backdrop-blur supports-[backdrop-filter]:bg-card/50">
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            <div className="relative">
              ...
              <Input
                placeholder="Search deleted notebooks..."
                value={searchTerm}
          ...
          {filteredNotebooks.length === 0 ? (
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium mb-2">
                {searchTerm ? 'No deleted notebooks found' : 'No deleted notebooks'}
              </h3>
                ...
                >
                  ...
                  <CardContent>
                    <p className="text-sm text-muted-foreground">
                      Deleted {notebook.deleted_at ? new Date(notebook.deleted_at).toLocaleDateString() : 'recently'}
                    </p>
                  </CardContent>
                </Card>
              ))}
